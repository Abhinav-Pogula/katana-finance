  ...
  return (
    <CrumpledPaper>
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        <ScrollView
          contentContainerStyle={[styles.scroll, { paddingHorizontal: wp(6) }]}
                  ...
                  <View style={styles.cardTop}>
                    <View style={styles.cardLeft}>
                      ...
                      <View style={{ marginLeft: s(12), flex: 1 }}>
                        <Text style={[styles.catName, { color: colors.text, fontSize: s(15) }]}>
                          {cat.name}
                        </Text>
                        {hasBudget ? (
      ...
      >
        ...
        >
          ...
          <View style={[styles.sheet, {
            ...
            padding: s(24),
            paddingBottom: Platform.OS === 'ios' ? s(50) : s(40),
          }]}>
